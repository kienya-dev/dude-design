(() => {
    ...
    document.addEventListener("DOMContentLoaded", (() => {
        function initSliders() {
            ...
            if (document.querySelector("[data-dzen-slider]")) new core("[data-dzen-slider]", {
                autoHeight: true,
                speed: 800,
                slidesPerView: "auto",
                spaceBetween: 16
            });
            if (document.querySelector("[data-stories-slider]")) new core("[data-stories-slider]", {
                modules: [ Navigation ],
                autoHeight: true,
                speed: 800,
                slidesPerView: "auto",
        ...
        if (showAuthorizationPopupButton) showAuthorizationPopupButton.addEventListener("click", (() => showPopup(authorizationPopup)));
        if (showButtonsOutPopup.length) showButtonsOutPopup.forEach((button => button.addEventListener("click", (() => showPopup(outPopup)))));
        if (showButtonsQuestionPopup.length) showButtonsQuestionPopup.forEach((button => button.addEventListener("click", (() => showPopup(questionPopup)))));
        ...
        const carouselStories = new core("[data-stories-carousel]", {
            effect: "fade",
            modules: [ Navigation ],
            speed: 200,
            spaceBetween: 0,
        ...
        const startInterval = (activeBullet, bullets = []) => {
            ...
            interval = setInterval((() => {
                if (width > 101) {
                    clearInterval(interval);
                    if (bullets.length == 1) if (storiesCards.length - 1 !== idxActiveSlide) {
                        activeStore.destroy(true, true);
                        if (document.querySelector("[data-active-store]")) {
                            const a = document.querySelector("[data-active-store] .swiper-wrapper");
                            a.classList.add("sw_no_td");
        ...
        let activeStore;
        const initStore = () => {
            activeStore = new core("[data-active-store]", {
                effect: "fade",
                speed: 800,
                ...
                on: {
                    ...
                    slideChange: function(swiper) {
                        ...
                        if (bulletNumber === bullets.length) if (storiesCards.length - 1 !== idxActiveSlide) {
                            clearInterval(interval);
                            activeStore.enabled = false;
                            if (document.querySelector("[data-active-store]")) {
                                const a = document.querySelector("[data-active-store] .swiper-wrapper");
        ...
        if (postSurvey) {
            ...
            const changeVote = inputs => {
                inputs.forEach((input => {
                    ...
                    } else surveyBox.classList.add("post-survey__row_active", "post-survey__row_select");
                }));
            };
                ...
                buttons.forEach((button => {
                    button.addEventListener("click", (() => {
                        authorizationForms.forEach((form => {
                            if (!form.hasAttribute(attr)) form.classList.remove("authorization_active"); else form.classList.add("authorization_active");
                        }));
                    }));
                }));
            };
        ...
        if (settingsPassword) settingsPassword.addEventListener("click", (() => showHidePassword(settingsPassword, "settings")));
    ...
    if (a) {
        ...
        function Ascroll() {
            if (b == null) {
                ...
                for (var i = 0; i < Sa.length; i++) if (Sa[i].indexOf("overflow") == 0 || Sa[i].indexOf("padding") == 0 || Sa[i].indexOf("border") == 0 || Sa[i].indexOf("outline") == 0 || Sa[i].indexOf("box-shadow") == 0 || Sa[i].indexOf("background") == "0") s += Sa[i] + ": " + Sa.getPropertyValue(Sa[i]) + "; ";
                b = document.createElement("div");
                b.style.cssText = s + " box-sizing: border-box; width: " + a.offsetWidth + "px;";
                a.insertBefore(b, a.firstChild);
                var l = a.childNodes.length;
                for (i = 1; i < l; i++) b.appendChild(a.childNodes[1]);
                a.style.height = b.getBoundingClientRect().height + "px";
                a.style.padding = "0";
                a.style.border = "0";
            }
            var Ra = a.getBoundingClientRect(), R = Math.round(Ra.top + b.getBoundingClientRect().height - document.querySelector(".article-cards__main").getBoundingClientRect().bottom);
